...
export default class ApiClient<T extends BaseResource, OmitFields extends keyof Omit<T, 'id'> = undefined, F extends { [k: string]: string } = undefined> {
  private readonly resource: string;

  constructor(resource: 'locations' | 'organisations' | 'needs' | 'access' | 'translations') {
